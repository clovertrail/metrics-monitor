// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TimeSeriesDefinition.cs" company="Microsoft Corporation">
...
namespace Microsoft.Cloud.Metrics.Client
{
    ...
    public sealed class TimeSeriesDefinition<TId>
    {
        ...
        public TimeSeriesDefinition(
            ...
            int seriesResolutionInMinutes = SerializationConstants.DefaultSeriesResolutionInMinutes,
        ...
        [DefaultValue(SerializationConstants.DefaultSeriesResolutionInMinutes)]
        ...
        private void ValidateAndNormalize()
        {
            ...
            if (this.SeriesResolutionInMinutes < SerializationConstants.DefaultSeriesResolutionInMinutes)
            {
                throw new ArgumentException($"seriesResolutionInMinutes must be >= {SerializationConstants.DefaultSeriesResolutionInMinutes}");
            }
